...
BESS_operating_cost(1:n) = 10;
BESS_round_trip_efficiency = 0.7; 

year_microgrid_demand_profile = csvread('oneYearPower.csv',1,1);
year_microgrid_demand_profile = year_microgrid_demand_profile(1:17520, 1);
