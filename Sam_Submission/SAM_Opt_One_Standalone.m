function[optimal_cost, wind_turbine_profile, capacity] = SAM_Opt_One_Standalone(Pn, Load_perhouse, Turbine_Base)
...
Cbess_Final = Cbm_Final + Cbc_Final; 
...
optimal_cost = Final_Cost(Minimum_Coordinates_1(1), Minimum_Coordinates_1(2), Minimum_Coordinates_1(3));
