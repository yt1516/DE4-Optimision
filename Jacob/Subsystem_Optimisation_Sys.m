function [names,turb_numbs,t_cost,P_out,coord_out,models] = Subsystem_Optimisation_Sys(x,y,start)
close all
...
for i=start:incre:start+10
    load_avg(end+1)=prctile(load_time,i); % start with 50% to 100% percentile at 5% increment
end
%%
cost = wt_models.cost;
