function [result] = BEN_BESS_profit(help, BESS_capacity)
...
function day_profit = compute_24h_profit(BESS_capacity, microgrid_load_profile, wind_profile, grid_import_price_profile, grid_export_price_profile)
    ...
    % BESS
    BESS_max_discharge_rate = 50*50;       % CHANGE
    BESS_max_charge_rate = 10*50;

    %BESS_max_SOC = 180;
    %BESS_min_SOC = 50;
    %BESS_capacity = 200;
    
    BESS_max_SOC = BESS_capacity*1;         % CHANGE 
    BESS_min_SOC = BESS_capacity*0;
    ...
    problem.Constraints.c10 = BESS_initial_SOC == BESS_capacity*0.5;
